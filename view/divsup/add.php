                    ...
                    <td>
                        ...
                        <br>
                          <label>No Faktur :</label><br/>
                              <input type="text" name="kd_pembelian" class="input">
                              <br/>
                          <label>tanggal</label><br/>
                              <input type="date" name="tanggal_beli" class="input">
                              <br/>
                          ...
                          <label>Jumlah</label><br/>
                              <input type="text" name="jml" class="input">
                              <br/>
                           <label>Harga Beli</label><br/>
                              <input type="text" name="hrg_barang" class="input">
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
